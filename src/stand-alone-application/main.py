...
def opengithub(event):
	webbrowser.open_new(r"https://github.com/AT-LEGEND/Cloud-based-secure-text-transfer")
...
def main():
	...
	global form
	form = tkinter.Tk()
	form.wm_title('Encryptor/Decryptor')
	'''
	-------------------------------------------------------------
	...
	Adisocial = Label(Aboutus, text="Adi Thakkar")

	Adisocial.grid(row=5, sticky='SW',padx = 8)
	text3 = Label(Aboutus, text="|")
	text3.grid(row=5)
	dharmiksocial = Label(Aboutus, text="Dharmik Govani")

	dharmiksocial.grid(row=5, sticky='SE',padx = 8)
